...
Source0  : https://github.com/solettaproject/soletta/archive/v1_beta16.tar.gz
...
tar -xf %{SOURCE1}
cd ..
%setup -q -n soletta-1_beta16
mkdir -p %{_topdir}/BUILD/soletta-1_beta16/src/thirdparty/duktape/
mv %{_topdir}/BUILD/duktape-release-duktape_v1_beta2/* %{_topdir}/BUILD/soletta-1_beta16/src/thirdparty/duktape/
