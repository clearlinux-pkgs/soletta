...
Source0  : https://github.com/solettaproject/soletta/archive/v1_beta15.tar.gz
...
License  : BSD-3-Clause GPL-2.0 MIT Python-2.0
...
tar -xf %{SOURCE1}
cd ..
%setup -q -n soletta-1_beta15
mkdir -p %{_topdir}/BUILD/soletta-1_beta15/src/thirdparty/duktape/
mv %{_topdir}/BUILD/duktape-release-duktape_v1_beta2/* %{_topdir}/BUILD/soletta-1_beta15/src/thirdparty/duktape/
