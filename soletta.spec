...
Source0  : https://github.com/solettaproject/soletta/archive/v1_beta18.tar.gz
...
tar -xf %{SOURCE3}
cd ..
%setup -q -n soletta-1_beta18
mkdir -p %{_topdir}/BUILD/soletta-1_beta18/src/thirdparty/duktape/
mv %{_topdir}/BUILD/duktape-release-duktape_v1_beta2/* %{_topdir}/BUILD/soletta-1_beta18/src/thirdparty/duktape/
mkdir -p %{_topdir}/BUILD/soletta-1_beta18/src/thirdparty/tinycbor/
mv %{_topdir}/BUILD/tinycbor-0.2/* %{_topdir}/BUILD/soletta-1_beta18/src/thirdparty/tinycbor/
mkdir -p %{_topdir}/BUILD/soletta-1_beta18/src/thirdparty/tinydtls/
mv %{_topdir}/BUILD/tinydtls-0.8.2/* %{_topdir}/BUILD/soletta-1_beta18/src/thirdparty/tinydtls/
mkdir -p %{_topdir}/BUILD/soletta-1_beta18/src/thirdparty/mavlink/
mv %{_topdir}/BUILD/c_library-master/* %{_topdir}/BUILD/soletta-1_beta18/src/thirdparty/mavlink/
...
%files data
%defattr(-,root,root,-)
/usr/share/gdb/auto-load/libsoletta.so.0.0.1-gdb.py
/usr/share/gdb/auto-load/libsoletta.so.0.0.1-gdb.pyc
/usr/share/gdb/auto-load/libsoletta.so.0.0.1-gdb.pyo
/usr/share/soletta/boards/50-default.json
/usr/share/soletta/flow/descriptions/accelerometer.json
...
/usr/share/soletta/flow/descriptions/stts751.json
...
/usr/include/soletta/sol-flow/stts751.h
