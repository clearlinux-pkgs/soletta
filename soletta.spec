...
Source0  : https://github.com/solettaproject/soletta/archive/v1_beta19.tar.gz
...
tar -xf %{SOURCE3}
cd ..
%setup -q -n soletta-1_beta19
mkdir -p %{_topdir}/BUILD/soletta-1_beta19/src/thirdparty/duktape/
mv %{_topdir}/BUILD/duktape-release-duktape_v1_beta2/* %{_topdir}/BUILD/soletta-1_beta19/src/thirdparty/duktape/
mkdir -p %{_topdir}/BUILD/soletta-1_beta19/src/thirdparty/tinycbor/
mv %{_topdir}/BUILD/tinycbor-0.2/* %{_topdir}/BUILD/soletta-1_beta19/src/thirdparty/tinycbor/
mkdir -p %{_topdir}/BUILD/soletta-1_beta19/src/thirdparty/tinydtls/
mv %{_topdir}/BUILD/tinydtls-0.8.2/* %{_topdir}/BUILD/soletta-1_beta19/src/thirdparty/tinydtls/
mkdir -p %{_topdir}/BUILD/soletta-1_beta19/src/thirdparty/mavlink/
mv %{_topdir}/BUILD/c_library-master/* %{_topdir}/BUILD/soletta-1_beta19/src/thirdparty/mavlink/
