...
Source0  : https://github.com/solettaproject/soletta/archive/v1_beta5.tar.gz
...
tar -xf %{SOURCE1}
cd ..
%setup -q -n soletta-1_beta5
mv %{_topdir}/BUILD/duktape-release-duktape_v1_beta2/* ./src/thirdparty/duktape/
...
/usr/share/soletta/board_detect.json
...
/usr/share/soletta/flow/descriptions/builtins.json
