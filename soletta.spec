...
tar -xf %{SOURCE3}
cd ..
%setup -q -n soletta-1_beta20
mkdir -p %{_topdir}/BUILD/soletta-1_beta20/src/thirdparty/duktape/
mv %{_topdir}/BUILD/duktape-release-duktape_v1_beta2/* %{_topdir}/BUILD/soletta-1_beta20/src/thirdparty/duktape/
mkdir -p %{_topdir}/BUILD/soletta-1_beta20/src/thirdparty/tinycbor/
mv %{_topdir}/BUILD/tinycbor-0.2/* %{_topdir}/BUILD/soletta-1_beta20/src/thirdparty/tinycbor/
mkdir -p %{_topdir}/BUILD/soletta-1_beta20/src/thirdparty/tinydtls/
mv %{_topdir}/BUILD/tinydtls-0.8.2/* %{_topdir}/BUILD/soletta-1_beta20/src/thirdparty/tinydtls/
mkdir -p %{_topdir}/BUILD/soletta-1_beta20/src/thirdparty/mavlink/
mv %{_topdir}/BUILD/c_library_v1-master/* %{_topdir}/BUILD/soletta-1_beta20/src/thirdparty/mavlink/
